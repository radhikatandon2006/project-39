...
function setup() {
  ...
  invisibleGround = createSprite(displayWidth/2,displayHeight-97,displayWidth,10);
  ...
  gameOver=createSprite(displayWidth/2,displayWidth/2-120,20,20);
  gameOver.addImage("gameisovertext",gameOverImage);
  gameOver.scale=0.6;
  
  resartGame=createSprite(displayWidth/2,width/2-80,20,20);
